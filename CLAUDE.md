...
- **`docs/content.md`** — the bar every problem, handbook page, workout, module and essentials-path
  session clears, and how to write each one. Read the relevant section before adding content.
